...
//! NOTE:
//! This file is taken from the [delve framework](https://github.com/Interrupt/delve-framework).
//! All credits go to [Interrupt](https://github.com/Interrupt).
//! In order to isolate code in this file I had to perform some slight
...
pub const AnimatedSpriteSheet = struct {
    ...
    pub fn initFromGrid(allocator: std.mem.Allocator, rows: u32, cols: u32, anim_name_prefix: [:0]const u8) !AnimatedSpriteSheet {
